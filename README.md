...
Das Programm ist sehr rechenintensiv. Um die neue Generation eines einzelnen Registers zu berechnen, müssen etwa 220 Instruktionen abgearbeitet werden. Da der Microtronic mehr als doppelt so schnell rechnet, wenn das Display ausgeschaltet bleibt, ist DISOUT praktisch ein Muss. Dann braucht ein Befehl immer noch etwa 9 ms, also sind 220 Befehle in 2 Sekunden durchlaufen. Alle 16 Register, also die komplette neue Generation, werden somit jede halbe Minute berechnet und angezeigt. Ein ziemlich gemütlicher Bildschirmschoner.
